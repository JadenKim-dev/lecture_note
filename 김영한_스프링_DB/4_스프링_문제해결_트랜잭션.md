...
스프링 부트에서는 DataSource, TransactionManager를 자동으로 등록해준다.  
Datasource는 application.properties 설정 파일의 spring.datasource에 정의한 내용을 바탕으로 생성해서 등록한다.  
커넥션풀을 사용하는 HikariDataSource 가 등록된다.  
